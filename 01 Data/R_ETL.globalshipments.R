...
file_path = "../../CSVs/PreETL_globalshipment.csv"
globalshipment <- readr::read_csv(file_path)
names(globalshipment)

df <- globalshipment
names(globalshipment)
str(globalshipment) # Uncomment this line and  run just the lines to here to get column types to use for getting the list of measures.

dimensions <- c("Order Date", "Ship Date", "Ship Mode", "Customer Name", "Segment", "City", "State", "Country", "Region", "Market", "Category", "Sub-Category", "Product Name", "Order Priority")
dimensions
